<section class="pt-8 md:pt-12 lg:pt-24 bg-[#2E2100] text-[#BFBCB2]">
    <div class="container">
        <div>
            <!-- MAIN FOOTER -->
            <div class="pb-[38px]">
                <div class="flex justify-between">
                    <!-- Description -->
                    <div class="lg:w-[35%]">
                        <div class="lg:w-[267px]">
                            <h4 class="text-2xl font-bold leading-[141.667%] text-[#FFFFFF!important] mb-[18px]">
                                Lesson<span class="text-primary">.</span>
                            </h4>
                            <p class="text-sm leading-[185.714%] mb-[18px]">
                    ...
                    <div class="lg:w-1/5">
                        <div>
                            <div class="mb-7">
                                <h5 class="font-semibold text-[#FFFFFF!important] leading-[175%] mb-[14px]">Company</h5>
                                <div class="bg-[#59554B] w-[130px] h-[1px]"></div> <!-- LINE -->
                            </div>
                            <ul class="space-y-3">
                                <li><a class="text-sm leading-[185.714%]" href="#">About Us</a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">Features</a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">Our Pricing</a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">Latest News</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="lg:w-1/5">
                        <div>
                            <div class="mb-7">
                                <h5 class="font-semibold text-[#FFFFFF!important] leading-[175%] mb-[14px]">Support</h5>
                                <div class="bg-[#59554B] w-[130px] h-[1px]"></div> <!-- LINE -->
                            </div>
                            <ul class="space-y-3">
                                <li><a class="text-sm leading-[185.714%]" href="#">FAQ's</a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">Terms & Conditions</a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">Privacy Policy</a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="lg:w-1/5">
                        <div>
                            <div class="mb-7">
                                <h5 class="font-semibold text-[#FFFFFF!important] leading-[175%] mb-[14px]">Address</h5>
                                <div class="bg-[#59554B] w-[130px] h-[1px]"></div> <!-- LINE -->
                            </div>
                            <ul class="space-y-3">
                                <li><a class="text-sm leading-[185.714%]" href="#">
                                        <span class="text-white font-semibold">Location: </span>
                                        27 Division St, New York, NY 10002, USA
                                    </a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">
                                        <span class="text-white font-semibold">Email: </span> email@gmail.com
                                    </a></li>
                                <li><a class="text-sm leading-[185.714%]" href="#">
                                        <span class="text-white font-semibold">Phone: </span>+ 000 1234 567 890
                                    </a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="w-full h-[1px] bg-[#59554B]"></div> <!-- LINE -->
            <!-- COPYRIGHT -->
            <div class="py-7">
                <p class="text-sm text-center leading-[185.714%] text-[#807D74]">Copyright ©2022 webdesign.gdn All
                    rights reserved</p>
            </div>
        </div>
    </div>
