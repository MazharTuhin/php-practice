<section id="testimonial" class="py-24 bg-[#2E2100]">
    <div class="container">
        <div class="flex flex-col-reverse md:flex-row gap-6 md:gap-0">
            <div class="w-full md:w-4/12 flex flex-col items-center md:items-start">
                <div class="w-[72px] h-[72px] rounded-full mb-[18px]">
                    <img class="w-full object-cover h-full rounded-full"
                        src="https://i.imghippo.com/files/QFN2253EY.png" alt="">
                </div>
                <h5 class="text-2xl leading-[141.667%] font-bold text-[#F7F7F7!important] mb-1">Peter Moor</h5>
                <p class="text-[#bfbcb2] text-sm leading-[185.714%] mb-7">Student of Web Design</p>
                <!-- DOTS -->
                <div class="flex items-center space-x-1.5 justify-center">
                    <button class="cursor-pointer inline-flex h-1.5 w-1.5 bg-[#5F5B53] rounded-full"></button>
                    <button class="cursor-pointer inline-flex h-1.5 w-1.5 bg-primary rounded-full"></button>
                    <button class="cursor-pointer inline-flex h-1.5 w-1.5 bg-[#5F5B53] rounded-full"></button>
                </div>
            </div>
            <div class="w-full md:w-8/12">
                ...
                <p class="text-[26px] leading-[153.846%] text-white italic pl-[30px]">
                    Not only does my resume look impressive—filled with the names and logos of world-class
                    institutions—but these certificates also bring me closer to my career goals by validating the skills
                    I've learned."
                </p>
            </div>
        </div>
